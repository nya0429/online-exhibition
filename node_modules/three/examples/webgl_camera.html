...
<html lang="en">
	...
	<body>
		...
		<script type="module">
			...
			var cameraPerspective, camera2;
			var cameraPerspectiveHelper, camera2Helper;
			var frustumSize = 600, controls;
			...
			function render() {
				...
				camera2.getWorldQuaternion(cameraPerspective.quaternion)
				cameraPerspective.quaternion.invert();
